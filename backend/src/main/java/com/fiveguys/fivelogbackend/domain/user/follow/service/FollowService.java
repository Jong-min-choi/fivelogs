...
public class FollowService {
    ...
    public void follow(Long loginUserId, Long followId) {
        if (followRepository.findByFollowIdAndFollowedId(loginUserId, followId).isPresent()) {
    ...
    public void unfollow(Long loginUserId, Long followId) {
        Follow follow = followRepository.findByFollowIdAndFollowedId(loginUserId, followId)
