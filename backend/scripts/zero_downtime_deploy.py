...
class ServiceManager:
    ...
    def _run_container(self, name: str, port: int) -> None:
         ...
         os.system(
             f"docker run -d --name={name} --restart unless-stopped -p {port}:8090 --network my-bridge-network -e TZ=Asia/Seoul -e SPRING_PROFILES_ACTIVE=prod -v /app/volumes/gen:/gen --pull always 752725210089.dkr.ecr.ap-northeast-2.amazonaws.com/fivelogs:latest")
